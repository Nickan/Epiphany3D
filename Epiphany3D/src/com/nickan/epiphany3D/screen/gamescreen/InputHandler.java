	...
	private void initializePauseButton() {
		...
		pauseButton.addListener(new InputListener() {
			...
			public void touchUp (InputEvent event, float x, float y, int pointer, int button) {
				InventoryScreen inventoryScreen = new InventoryScreen(game, game.gameScreen);
				inventoryScreen.renderer.setBitmapFont(world.renderer.arial, world.renderer.comic);
